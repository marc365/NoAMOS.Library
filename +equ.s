...
; ~~~~~~~~~~~~~~~~~~
		RsReset
		rs.b	Dia_ZoLong	Entete zone active
Dia_Sl		rs.b	Sl_Long		Slider management data
Dia_SlLong	equ	__RS
...
;		Def Scroll, reduced to 10 zones!
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
NDScrolls	equ	10
...
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
;              Data from Interpreter Configuration
;
PI_Start	equ	__RS
...
Edt_SInit	equ	__RS		Area to be reset
...
Edt_PrgDelete	rs.b	1		Program to be deleted on return
...
;		Data area specific to each library...
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
LB_MemAd	equ	-4
LB_MemSize	equ	-8
LB_NRout	equ	-10
